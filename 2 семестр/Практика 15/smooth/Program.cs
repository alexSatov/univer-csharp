...
namespace yield
{
	class Program
	{
		...
		private PointPairList minPoints;
		private PointPairList maxPoints;
		...
		public Program()
		{
			...
			minPoints = AddCurve("min", Color.Green);
		...
		private void OnShown(object sender, EventArgs e)
		{
			thread = new Thread(() =>
			{
				...
				foreach (var point in DataTask.GetData(new Random()))
				{
					if (canceled) return;
					var pointCopy = point;
